...
def VAE(input_shape=[None, 784],
    ...
    loss_0d, loss_1d, loss_2d, loss_3d, _, _, nebula3d = sparse_ml(
            n_clusters, n_code, nebula3d, z, label, info_type='scalar')
